...
func logHandler(appctx *appctx.Context, c *el.Contract) el.LogHandleFunc {
...
func NewTokenFactoryEventListener() (*el.EventListener, error) {
	c := el.ChainConfig{
		ChainId:   11155111,
	...
	tokenFactory.SetLogHandler(logHandler(&appctx.Context{}, tokenFactory))
